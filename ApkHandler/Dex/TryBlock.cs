...
{
    internal class TryBlock : ITryBlock
    {
        #region CONSTRUCTORS
        internal TryBlock(uint methodStartOffset, ushort blockSize)
        {
        ...
        #region PROPERTIES
        internal GuardHandlers Handlers { get; set; }
        ...
        internal class SortKey : IComparable<SortKey>
        {
            #region CONSTRUCTORS
